...
import com.gmail.abanoubwagih.gp_project.LaunchActivty;
...
//        uploadData(new User("Cairo", "21 al hkim street", "abanoub", "abanoubwagih", 3, building));
        ...
        uploadData(new User("Cairo", "21 al hkim street", "abanoub", "abanoubwagih", building.size(), building));
